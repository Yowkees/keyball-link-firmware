...
// Include SROM definitions only when upload is needed.
// Without KEYBALL_PMW3360_UPLOAD_SROM_ID defined, no SROM is uploaded
// and these ~8KB of data are excluded from flash.
